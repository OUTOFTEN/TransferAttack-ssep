...
attack_zoo = {
    ...
    # ssep
    'sseppgn': ('.myexp.pgn_gram', 'PGNGRAM'),
    'sseppgn_admix':('.myexp.pgn_gram', 'SSEPPGN_Admix'),
    'sseppgn_sia':('.myexp.pgn_gram', 'SSEPPGN_SIA'),
    'sseppgn_bsr':('.myexp.pgn_gram', 'SSEPPGN_BSR'),
    'sseppgn_dim':('.myexp.pgn_gram', 'SSEPPGN_DIM'),
    'ssepmi':('.myexp.mi_gram', 'SSEPMI'),
    'ssepmi_dim':('.myexp.mi_gram', 'SSEPMI_DIM'),
    'ssepmi_admix':('.myexp.mi_gram', 'SSEPMI_Admix'),
    'ssepmi_sia':('.myexp.mi_gram', 'SSEPMI_SIA'),
    'ssepmi_bsr':('.myexp.mi_gram', 'SSEPMI_BSR'),
